 ...
 */
export const calculateRelationshipStats = (
  startDate: string,
): RelationshipStats => {
 ...
 */
export const calculateAnniversaryCountdown = (
  startDate: string,
  ...
  try {
    ...
    const thisYearAnnivDateOnly = new Date(
      current.getFullYear(),
      start.getMonth(),
      start.getDate(),
    );
 ...
 */
export const createThemedGradient = (
  themeColor: string,
  opacity1: number = 0.1,
  opacity2: number = 0.2,
): string => {
  return `linear-gradient(135deg, ${themeColor}${Math.round(opacity1 * 100)
    .toString(16)
    .padStart(2, "0")}, ${themeColor}${Math.round(opacity2 * 100)
    .toString(16)
    .padStart(2, "0")}, #ffffff)`;
};
...
export const createThemedShadow = (
  ...
  return `0 8px 25px ${themeColor}${Math.round(opacity * 100)
    .toString(16)
    .padStart(2, "0")}`;
};
