...
import { Upload, X, Calendar, Heart, Image as ImageIcon, FileText, Loader2 } from 'lucide-react';
        ...
        action: {
          ...
          onClick: () => {
            toast.info('Please try creating the memory again', {
              description: 'The upload dialog has been closed. Please click upload again to retry.',
              duration: 3000,
            });
          },
        },
