...
const TarotCardsWidgetView: React.FC<TarotCardsWidgetViewProps> = ({ onNavigate }) => {
  // Reading context is now managed by the store, get it when needed
  ...
  useEffect(() => {
    const initialize = async () => {
      try {
        ...
        console.error('Failed to initialize TarotCardsWidgetView:', error);
